...
def checkio(game):
    if game[0][0]==game[1][1]==game[2][2] or game[2][0]==game[1][1]==game[0][2]:
        if game[1][1]=='X':
            ...
            return 'D'
    elif game[0][0]==game[0][1]==game[0][2]=='X' or game[1][0]==game[1][1]==game[1][2]=='X' or game[2][0]==game[2][1]==game[2][2]=='X' or game[0][0]==game[1][0]==game[2][0]=='X' or game[0][1]==game[1][1]==game[2][1]=='X' or game[0][2]==game[1][2]==game[2][2]=='X':
        return 'X'
    elif game[0][0]==game[0][1]==game[0][2]=='O' or game[1][0]==game[1][1]==game[1][2]=='O' or game[2][0]==game[2][1]==game[2][2]=='O' or game[0][0]==game[1][0]==game[2][0]=='O' or game[0][1]==game[1][1]==game[2][1]=='O' or game[0][2]==game[1][2]==game[2][2]=='O':
        return 'O'
    else:
        return 'D'
print (checkio([
